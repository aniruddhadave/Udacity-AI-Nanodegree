...
class PlanningGraph():
    ...
    def add_literal_level(self, level):
        ...
        for node_a in self.a_levels[level - 1]:
            # Get the effect nodes for the previous action and add them to the current level's state nodes
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        '''
        # Make sure node_a1's add effects aren't canceled by node_a2's rem effects
        for effect in node_a1.action.effect_add:
            if effect in node_a2.action.effect_rem:
                return True

        # Make sure node_a2's add effects aren't canceled by node_a1's rem effects
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        '''
        # Make sure node_a1's add effects don't conflict with node_a2's neg preconditions
        # Make sure node_a2's add effects don't conflict with node_a1's neg preconditions
        for effect in node_a1.action.effect_add:
        ...
        # Make sure node_a1's neg effects don't conflict with node_a2's add preconditions
        # Make sure node_a2's neg effects don't conflict with node_a1's add preconditions
    ...
    def h_levelsum(self) -> int:
        ...
        level_sum = 0
        # Determine level cost for each goal and then add them together
